...
import { fetchBookHistory, setGivenPrice, setPaid } from '../utils/adminRoomsHistory';
        ...
        <div class="list-container">
            ...
            <div class="buttonBlock">
                <div class="controls">
                    ...
                    <button @click="fetchData({ paid: true })" type="button"
                        class="btn btn-success text-white">Оплачен</button>
                    <button @click="fetchData({ completed: false })" type="button"
                        class="btn btn-success text-white">Незавершенные</button>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked"
                                    :checked="item.isPaid === 1" @change="togglePaid(item.id, item.isPaid)" />
                            </td>
                            <td>
                                <form @submit.prevent="setGiven(item.id, item.given)">
                                    <input v-model="item.given" class="text-center" type="number" />
                                </form>
                            </td>
                            <td>
